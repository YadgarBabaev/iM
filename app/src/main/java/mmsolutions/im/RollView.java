...
public class RollView extends LinearLayout implements OnScrollListener{
	...
	private final List<String> listString = new ArrayList<>();//Список входчщих строк
	private final List<View> listViews = new ArrayList<>(); //Список View для обновления размера текста
	...
	public RollView(Context context) {
		...
		innerListView = (ListView) inf.inflate(R.layout.list, null);
	...
	private void addEmptyElementsToArray(){
		...
		List<Object> stringTodelete = new ArrayList<Object>();
	...
	private class RollAdapter extends ArrayAdapter<String> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			ShadowTextView tv = (ShadowTextView) convertView.findViewById(R.id.text);
		...
		void refreshLayoutParams(){
			...
			final RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) RollView.this.getLayoutParams();
